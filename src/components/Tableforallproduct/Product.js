...
export default function Product({data}) {
    return (
      ...
      <Secondnavproduct Name={{name:"All Products", directory:"Products > All Products"}} Btn={[{name:"Upload Bulk Products", style:"", icon:'las la-plus-circle'},{name:"Add Product",style: "bluebtn pb-2 my-0", link :"/Addproducts", icon:'las la-plus-circle'}]}/>
